...
public class OperandFetch {
	...
	public void performOF()
	{
		if(IF_OF_Latch.isOF_enable())
		{
			...
			if(OF_EX_Latch.getRd() == rs1_val || OF_EX_Latch.getRd() == rs2_val || EX_MA_Latch.getRd() == rs1_val || EX_MA_Latch.getRd() == rs2_val || MA_RW_Latch.getRd() == rs1_val || MA_RW_Latch.getRd() == rs2_val){
